  ...
  const createGaleri = async (payload: GaleriData) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:4000/api/gallery/upload",
        payload,
...
export function useUploadGaleriImage() {
  ...
  const uploadImage = async (file: File) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:4000/api/gallery/upload-docs",
        formData,
        {
          headers: {
  ...
  const deleteGaleri = async (galeriId: number) => {
    ...
    try {
      const response = await axios.delete(
        `http://localhost:4000/api/gallery/${galeriId}`,
        { withCredentials: true }
      );
      setSuccess(true);
      return response.data;
...
export function useGetAllGaleri() {
  ...
  const fetchGaleri = async () => {
    ...
    try {
      const response = await axios.get("http://localhost:4000/api/gallery/all", {withCredentials: true});
